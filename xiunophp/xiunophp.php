...
version_compare(PHP_VERSION, '5.3.0', '<') AND function_exists('set_magic_quotes_runtime') AND set_magic_quotes_runtime(0);
$get_magic_quotes_gpc = version_compare(PHP_VERSION,'5.4.0','<') ? (function_exists('get_magic_quotes_gpc') ? get_magic_quotes_gpc() : false) : false;
