...
![master version](https://img.shields.io/badge/master-v1.1.1-%231ab1ad.svg) ![dev version](https://img.shields.io/badge/dev-v2.0.0_b11-brightgreen.svg)
...
- [x] 增加兼容组件，修复因 Bootstrap5 延迟注册导致本属于 tooltip 的方法被误覆盖的问题`【2.0.0-b11】`
- [x] 进行部分安全加固；修复安装程序在 MySQL 8.0 下与保留字段冲突的问题`【2.0.0-b12】`
